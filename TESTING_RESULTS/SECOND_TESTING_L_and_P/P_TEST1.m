% P tests
% with older hardware, had trouble listening to buzzer

load("P1.mat");
% desrired HR = 150
% length of workout = 10 mins
HR_exp = PHRE1(1:2:end);
HR_exp_time = PHRE1(2:2:end);
...
% 1. PHR1 - inst. HR with time stamps
% 2. PSPM1 - inst. cadence with time stamps
% 3. PCAD1 - desired cadence
HR_time = PHR1(2:2:end);
HR_time = HR_time / 60000; % converting to mins
HR = PHR1(1:2:end); % is in bpm

SPM_time = PSPM1(2:2:end);
SPM_time = SPM_time / 60000; % also converting to mins
SPM = PSPM1(1:2:end); % is in steps per min (SPM)

CAD_time = PCAD1(2:2:end);
