% first test with new hardware
% worked pretty well, a little oscillatory but good

load("L1.mat");
% desrired HR = 150
% length of workout = 10 mins
HR_exp = LHRE1(1:2:end);
HR_exp_time = LHRE1(2:2:end);
...
HR_time = LHR1(2:2:end);
HR_time = HR_time / 60000; % converting to mins
HR = LHR1(1:2:end); % is in bpm

SPM_time = LSPM1(2:2:end);
SPM_time = SPM_time / 60000; % also converting to mins
SPM = LSPM1(1:2:end); % is in steps per min (SPM)

CAD_time = LCAD1(2:2:end);
