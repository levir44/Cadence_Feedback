% Katie test 1 - zero slope
% noise is even worse in this test

load("K1.mat");
% desrired HR = 150
% length of workout = 10 mins
HR_exp = KHRE1(1:2:end);
HR_exp_time = KHRE1(2:2:end);
...
HR_time = KHR1(2:2:end);
HR_time = HR_time / 60000; % converting to mins
HR = KHR1(1:2:end); % is in bpm

SPM_time = KSPM1(2:2:end);
SPM_time = SPM_time / 60000; % also converting to mins
SPM = KSPM1(1:2:end); % is in steps per min (SPM)

CAD_time = KCAD1(2:2:end);
